...
public class StandardService
        extends GenericService<StandardEntity, StandardDTO, StandardFilterDTO, StandardRepository> {
    ...
    @Override
    protected void fetchRelations(StandardEntity entity, StandardDTO dto) throws ApplicationException {
    }
}
