...
public class FaultController extends GenericController<
    FaultEntity,
    FaultDTO,
    FaultFilterDTO,
    FaultRepository,
    ...
    public ResponseEntity<FaultDTO> getById(@PathVariable String idOrUuid) {
    ...
    public ResponseEntity<FaultDTO> create(@RequestBody FaultDTO dto) {
