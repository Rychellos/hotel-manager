...
public class MediaController
        extends GenericController<MediaEntity, MediaDTO, MediaFilterDTO, MediaRepository, MediaService> {
    ...
    public Page<MediaDTO> getMedia(
            ...
            @ParameterObject MediaFilterDTO filter) throws ApplicationException {
    ...
    public ResponseEntity<MediaDTO> getById(@PathVariable String idOrUuid) throws ApplicationException {
    ...
    public ResponseEntity<MediaDTO> update(
            ...
            @RequestBody MediaDTO dto) throws ApplicationException {
