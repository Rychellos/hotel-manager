...
public class CurrencyController
        extends GenericController<CurrencyEntity, CurrencyDTO, CurrencyFilterDTO, CurrencyRepository, CurrencyService> {
    ...
    public CurrencyDTO get(@PathVariable String code) throws ApplicationException {
