...
public class FaultTypeController extends
        GenericController<FaultTypeEntity, FaultTypeDTO, FaultTypeFilterDTO, FaultTypeRepository, FaultTypeService> {
    ...
    public Page<FaultTypeDTO> getFaultTypes(
            ...
            @ParameterObject FaultTypeFilterDTO filter) throws ApplicationException {
    ...
    public ResponseEntity<FaultTypeDTO> getById(@PathVariable String idOrUuid) throws ApplicationException {
    ...
    public ResponseEntity<FaultTypeDTO> create(@RequestBody FaultTypeDTO dto) throws ApplicationException {
    ...
    public ResponseEntity<FaultTypeDTO> update(
            ...
            @RequestBody FaultTypeDTO dto) throws ApplicationException {
