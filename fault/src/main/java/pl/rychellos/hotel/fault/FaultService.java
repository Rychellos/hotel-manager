...
@Service
public class FaultService extends GenericService<FaultEntity, FaultDTO, FaultFilterDTO, FaultRepository> {
    ...
    @Override
    protected void fetchRelations(FaultEntity entity, FaultDTO dto) throws ApplicationException {
